...
| ICE | Shortened prioritisation with quantifiable metrics | Impact x Confidence x Ease | Data-driven, objective, faster than RICE | Easy to distort priorities, no sense of user scale |
